...
const canDelete = computed(
  () => deleteConfirmText.value === t("settings.danger.modal.confirmText"),
);
...
<template>
  <section class="mx-auto max-w-2xl px-6 py-8 space-y-8">
    ...
    <div
      ...
      :class="
        isDark ? 'bg-[#1a1a1a] ring-1 ring-white/10' : 'bg-white ring-1 ring-gray-200 shadow-sm'
      "
    >
    ...
    >
      ...
      <div
        ...
        class="mb-4 p-3 rounded-lg bg-green-500/10 text-green-500 text-sm"
      >
    ...
    <!-- Danger Zone -->
    <div class="rounded-2xl p-6 ring-1 ring-red-500/30 bg-red-500/5">
        ...
        <div v-if="showDeleteModal" class="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          >
            ...
            <p class="text-center text-sm mb-6" :class="isDark ? 'text-white/50' : 'text-gray-500'">
              {{
                t("settings.danger.modal.description", {
                  confirm: t("settings.danger.modal.confirmText"),
                })
              }}
            </p>
