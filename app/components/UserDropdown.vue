  ...
  <div class="relative user-dropdown">
    ...
    >
      ...
      <svg
        ...
        :class="[isOpen ? 'rotate-180' : '', isDark ? 'text-white/50' : 'text-gray-400']"
        viewBox="0 0 24 24"
        fill="none"
        stroke="currentColor"
        stroke-width="2"
    ...
    <Transition name="dropdown">
      <div
        ...
        :class="isDark ? 'bg-[#1a1a1a] ring-1 ring-white/10' : 'bg-white ring-1 ring-gray-200'"
      >
        <!-- User Info -->
        <div class="p-4 border-b" :class="isDark ? 'border-white/10' : 'border-gray-100'">
          ...
          <div v-if="store.isAdmin" class="mt-3">
            <span
              class="inline-flex items-center gap-1.5 px-2 py-1 text-xs font-medium rounded-lg bg-purple-500/10 text-purple-500"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                class="w-3.5 h-3.5"
